    ...
    children: [
      {
        ...
        props: { id: "translate" },
        //props: true,
        redirect: { name: "translate-isoftstone" },
        meta: {
          keepAlive: true,
        },
        children: [
          {
            path: "/translate/isoftstone",
            name: "translate-isoftstone",
            component: () => import("@/views/translate/isoftstone/index.vue"),
            meta: {
              keepAlive: true,
            },
          },
      ...
      },
      {
        ...
        props: { id: "settings" },
        //props: true,
        redirect: { name: "settings-translate" },
        children: [
          {
            path: "/settings/translate",
            name: "settings-translate",
            component: () => import("@/views/settings/translate/index.vue"),
          },
        ],
      },
      {
